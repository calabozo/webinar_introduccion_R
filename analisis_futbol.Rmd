...
Podemos ver la proproción de nacimiento en cada mes. Hay que tener en cuenta que no todos los meses tienen los mismos días, por eso hay meses donde hay menos nacimientos
```{r}
